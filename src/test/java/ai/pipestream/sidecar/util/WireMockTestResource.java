 ...
 * <p>
 * This provides a real gRPC server that mocks the Engine and Repository services
 * that the Kafka Sidecar calls. It handles both unary and streaming gRPC calls.
 * <p>
 * The WireMock server exposes:
 * <ul>
 *   <li>Port 8080: Standard gRPC server (reflection-enabled) for most services</li>
 *   <li>Port 50052: Direct streaming gRPC server for large streaming scenarios</li>
 * </ul>
 * <p>
 * Services mocked include:
 * <ul>
 *   <li>EngineV1Service: IntakeHandoff, ProcessNode endpoints</li>
 *   <li>PipeDocService: GetPipeDocByReference for document hydration</li>
 *   <li>AccountService: Account validation</li>
 * </ul>
 */
public class WireMockTestResource implements QuarkusTestResourceLifecycleManager {

    private static final Logger LOG = LoggerFactory.getLogger(WireMockTestResource.class);
    ...
    public Map<String, String> start() {
        ...
        Integer grpcPort = wireMockContainer.getMappedPort(8080);
        Integer directPort = wireMockContainer.getMappedPort(50052);
